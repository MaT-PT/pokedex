...
character_table_gen5 = {
    ...
    0x24: u'$',  # pokémoney sign
    0x21d2: u'☹',  # frowny face
    0x21d4: u'↗',  # left-then-up arrow
    0x2200: u'↘',  # left-then-down arrow
    ...
    # 0x2462: hurt face
    # 0x2463: frowny face
    # 0x2464: left-then-up arrow
    # 0x2465: left-then-down arrow
    # 0x2466: ZZ ligature
    ...
    # 0x2482: halfwidth left-then-up arrow
    # 0x2483: halfwidth left-then-down arrow
